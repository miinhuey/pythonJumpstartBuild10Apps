...
def query_data(data):
    ...
    print("The average price of a 2-bedroom home is ${:,}, baths={}, sq ft={:,}.".format(int(ave_price), round(ave_baths), round(ave_sqft)))
...
# Task 1: Find all houses that are match my requirements
# (3 bedroom, near a city)
# Task 2: Find all houses that are for sale that I might in theory buy
# Task 3: Find all houses I might buy near me
